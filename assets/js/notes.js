...
function addNoteRender() {
    ...
    if (currentNote) {
        document.getElementById(currentNote).classList.remove("currentNote")
    ...
    if (myNotes.length == 0) {
        ...
        localStorage.setItem("currentNote", myNotes[(myNotes.length - 1)].id)
        document.getElementById(currentNote).classList.add("currentNote");
